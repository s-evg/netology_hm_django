# Generated by Django 3.2.7 on 2021-10-01 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='scopes', to='articles.scope')),
            ],
            options={
                'verbose_name': 'Тег',
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(through='articles.Tag', to='articles.Scope'),
        ),
    ]
